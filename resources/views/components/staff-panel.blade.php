<div class="sidebar-menu">
    <ul>
        ...
        <li>
            <a class="p-space-0.1 tablinks" onclick="switchcommon(event, 'main-2')"
        ...
        <li>
            <a class="p-space-0.1 tablinks" onclick="switchcommon(event, 'main-3')"
               style="cursor: pointer">
                Shift Hours
            </a>
        </li>
        ...
        <li>
            <a class="p-space-0.1 tablinks" onclick="switchcommon(event, 'main-4')"
               style="cursor: pointer">
        ...
        <li>
            <a class="p-space-0.1 tablinks" onclick="switchcommon(event, 'main-5')"
               style="cursor: pointer">
                Forum
            </a>
        </li>
